...
package org.ngnl.core.test.objectUtils;
...
import com.ngnl.core.utils.ClassUtils;
import com.ngnl.core.utils.ObjectUtils;
import com.ngnl.core.utils.StringUtils;
...
public class ObjectUtilsTests {
	...
	public void isEmptyArray() {
		...
		assertTrue(StringUtils.isEmpty(new Integer[0]));

		assertFalse(StringUtils.isEmpty(new int[] { 42 }));
		assertFalse(StringUtils.isEmpty(new Integer[] { 42 }));
	}

	@Test
	public void isEmptyCollection() {
		assertTrue(StringUtils.isEmpty(Collections.emptyList()));
		assertTrue(StringUtils.isEmpty(Collections.emptySet()));

		Set<String> set = new HashSet<>();
		set.add("foo");
		assertFalse(StringUtils.isEmpty(set));
		assertFalse(StringUtils.isEmpty(Arrays.asList("foo")));
	}

	@Test
	public void isEmptyMap() {
		assertTrue(StringUtils.isEmpty(Collections.emptyMap()));
	...
	public void isEmptyCharSequence() {
		...
		assertFalse(StringUtils.isEmpty(new StringBuilder("foo")));
	...
	public void isEmptyUnsupportedObjectType() {
		assertFalse(StringUtils.isEmpty(42L));
