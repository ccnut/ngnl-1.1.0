...
public class SocketClientTest {
	...
	public static void main (String[] args) throws Exception{
		...
		socketClient.setChannelInitializer(new SocketClientInitializer());
		socketClient.connect("localhost", 8400);
	}
}
...
class SocketClientInitializer extends ChannelInitializer<SocketChannel>{
	...
	protected void initChannel(SocketChannel ch) throws Exception {
		...
		pipline.addLast("LengthFieldBasedFrameDecoder", new LengthFieldBasedFrameDecoder(Integer.MAX_VALUE, 0, 4, 0, 4))
			   ...
			   .addLast("socketServerHandler", new SocketClientHandler());
	}
...
class SocketClientHandler extends SimpleChannelInboundHandler<String>{
	...
	protected void channelRead0(ChannelHandlerContext ctx, String msg) throws Exception {
		...
		logger.info("from remote server {}, msg:{}", channel.remoteAddress(), msg);
		logger.info(msg);
